...
//            configureBounds();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mFactory == null) {
            ...
            if (mDrawable == null || !imageBlockImageLoader.hasLoad() || (imageBlockImageLoader.getWidth() * imageBlockImageLoader
                    .getHeight() > (displayMetrics.widthPixels * displayMetrics.heightPixels))) {
    ...
    private GestureDetector.SimpleOnGestureListener simpleOnGestureListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            ...
            overScrollByCompat((int) distanceX, (int) distanceY, getScrollX(), getScrollY(), getScrollRangeX(), getScrollRangeY(), 0, 0,
                    false);
            return true;
        }
